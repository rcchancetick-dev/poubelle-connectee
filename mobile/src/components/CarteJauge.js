...
import { couleurs, couleurNiveau } from '../theme/colors';
    ...
    <View style={[styles.carte, enAlerte && styles.carteAlerte]}>
      ...
      <View style={styles.jaugeConteneur}>
        <Svg width={110} height={110} viewBox="0 0 110 110">
          <Circle cx={55} cy={55} r={rayon} stroke="#eef1f6" strokeWidth={10} fill="none" />
          <Circle
...
const styles = StyleSheet.create({
  carte: {
    ...
    shadowColor: '#1e293b', shadowOpacity: 0.06, shadowRadius: 8, shadowOffset: { width: 0, height: 4 }, elevation: 2,
  },
  carteAlerte: { borderColor: 'rgba(239,68,68,0.4)' },
  badgeAlerte: {
    position: 'absolute', top: 10, right: 10, flexDirection: 'row', alignItems: 'center', gap: 4,
    backgroundColor: 'rgba(239,68,68,0.1)', paddingHorizontal: 6, paddingVertical: 3, borderRadius: 20,
  },
  ...
  texteHistorique: { fontSize: 12, color: couleurs.bleu, fontWeight: '600', marginLeft: 4 },
});
